         ...
         stage('DAST'){
            steps{
        		...
        		script{
                   ...
                   sh '${DOCKER_EXEC} run --add-host="localhost:10.192.10.4" -v /Users/asajuro/Documents/BCI/AnalyzeQAS/Jenkins-Practica/USACH/ayudantia/full/jenkins_home/tools:/zap/wrk/:rw --rm -i owasp/zap2docker-stable zap-baseline.py -t "https://demo.testfire.net/" -I -r zap_baseline_report.html -l PASS'
